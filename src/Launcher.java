...
public class Launcher extends JFrame implements ActionListener
{
	...
	private TextBox percentageField;
	...
	private static final String percentageDescription = "Repeat Percentage";
	...
	public Launcher(String name)
	{
		...
		percentageField = new TextBox(percentageDescription);
		...
		percentageField.setMinimumSize(new Dimension(fieldWidth, fieldHeight));
		...
		percentageField.setMaximumSize(new Dimension(fieldWidth, fieldHeight));
		...
		percentageField.setFont(textFont);
		...
		percentageField.setToolTipText(percentageDescription);
		...
		panel.add(Box.createRigidArea(new Dimension(0, 10)));
		panel.add(percentageField, Component.CENTER_ALIGNMENT);
		panel.add(Box.createRigidArea(new Dimension(0, 10)));
	...
	public void actionPerformed(ActionEvent e)
	{
		if (e.getSource().equals(practiceButton))
		{
	    	...
	    	m.run(nameField.getCurrentText(), languageField.getCurrentText(), levelField.getCurrentText(), percentageField.getCurrentText(), dictionaryPathField.getCurrentText(), userDataPathField.getCurrentText()
);
	...
	private void loadConfig() throws IOException
	{
		...
		while ((line = in.readLine()) != null)
		{
			...
			{
				percentageField.setCurrentText(value);
			}
	...
	private void saveConfig() throws IOException
	{
		...
		out.newLine();
		out.write("percentage:" + percentageField.getCurrentText());
		out.newLine();
